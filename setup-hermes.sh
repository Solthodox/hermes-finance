...
echo ""
echo -e "${CYAN}⚕ Hermes Finance Setup${NC}"
echo ""
...
HERMES_BIN="$SCRIPT_DIR/venv/bin/hermes-finance"
...
# ============================================================================
# Seed bundled skills into ~/.hermes-finance/skills/
# ============================================================================

HERMES_SKILLS_DIR="${HERMES_HOME:-$HOME/.hermes-finance}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.hermes-finance/skills/ ..."
...
echo "Other commands:"
echo "  hermes-finance status        # Check configuration"
if is_termux; then
    echo "  hermes-finance gateway       # Run gateway in foreground"
else
    echo "  hermes-finance gateway install # Install gateway service (messaging + cron)"
fi
echo "  hermes-finance cron list     # View scheduled jobs"
echo "  hermes-finance doctor        # Diagnose issues"
echo ""
