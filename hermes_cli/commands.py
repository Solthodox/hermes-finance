...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.hermes-finance/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update Hermes Finance to the latest version", "Info",
               gateway_only=True),
...
def slack_app_manifest(request_url: str = "https://hermes-finance.local/slack/commands") -> dict[str, Any]:
