...
``https://solthodox.github.io/hermes-finance/api/model-catalog.json``
"""
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "hermes-finance repo",
            "docs": "https://solthodox.github.io/hermes-finance/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
