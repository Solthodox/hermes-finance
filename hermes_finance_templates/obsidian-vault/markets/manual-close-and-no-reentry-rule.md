---
id: manual-close-and-no-reentry-rule
title: Manual Close And No-Reentry Rule
type: market
...
# Manual Close And No-Reentry Rule

If the user closes a thesis manually, do not re-enter the cluster without explicit approval and fresh evidence.
