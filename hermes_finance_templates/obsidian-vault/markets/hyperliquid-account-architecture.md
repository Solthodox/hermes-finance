---
id: hyperliquid-account-architecture
title: Hyperliquid Account Architecture
type: market
...
Main account, agent/API wallets, unified account caveats, vaults, and what must be verified before trading.
