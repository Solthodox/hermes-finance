---
id: polymarket-direct-mcp-safety
title: Polymarket Direct MCP Safety
type: market
...
# Polymarket Direct MCP Safety

Safety protocol for direct Polymarket MCP order placement: explicit approval, live positions, max loss, and logged decision record.
