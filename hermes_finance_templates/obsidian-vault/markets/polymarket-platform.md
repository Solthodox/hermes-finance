...
Core platform model: binary outcome tokens, UMA-style resolution, CLOB execution, fees, and portfolio accounting.
...
[[risk-management-framework]], [[decision-record-template]]
