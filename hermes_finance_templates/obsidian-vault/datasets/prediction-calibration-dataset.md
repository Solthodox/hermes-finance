---
id: prediction-calibration-dataset
title: Prediction Calibration Dataset
type: dataset
...
# Prediction Calibration Dataset

Dataset structure for comparing predicted probabilities to realized binary outcomes.
