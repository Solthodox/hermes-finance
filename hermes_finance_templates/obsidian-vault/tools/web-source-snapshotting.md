---
id: web-source-snapshotting
title: Web Source Snapshotting
type: tool
...
# Web Source Snapshotting

When to preserve raw web pages, API responses, and screenshots so future reasoning can audit the evidence trail.
