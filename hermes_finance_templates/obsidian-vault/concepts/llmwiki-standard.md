...
Karpathy-style LLMWiki rules for raw immutable sources, synthesized wiki notes, schema, index, log, ingest, query, and lint operations.
...
[[ingestion-playbook]], [[lint-checklist]], [[source-quality]]
