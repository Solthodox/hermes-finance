...
const config: Config = {
  ...
  tagline: 'Pragmatic, analytic finance AI agent',
  favicon: 'img/favicon.ico',

  url: 'https://solthodox.github.io',
  baseUrl: '/hermes-finance/',

  organizationName: 'Solthodox',
  projectName: 'hermes-finance',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Solthodox/hermes-finance/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://solthodox.github.io/hermes-finance',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/Solthodox/hermes-finance',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/Solthodox/hermes-finance/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/Solthodox/hermes-finance' },
